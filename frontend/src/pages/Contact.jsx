...
const CONTENT = {
  ko: {
    ...
    labelEmail: "Email", labelPhone: "Phone", labelLocations: "LOCATIONS",
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <div className="mt-12 space-y-7">
                <div>
                  ...
                  <a href="mailto:contact@k-bridge-partners.com" className="font-serif-kr text-xl hover:text-[color:var(--kb-gold)] transition-colors break-all">
                    contact@k-bridge-partners.com
                  </a>
                </div>
                <div>
                  <div className="flex items-center gap-2 text-[10px] tracking-[0.3em] uppercase text-[color:var(--kb-muted)] mb-2">
                    <Phone size={12} className="text-[color:var(--kb-gold)]" /> {t.labelPhone}
                  </div>
                  <a href="tel:+17036299056" className="font-serif-kr text-xl hover:text-[color:var(--kb-gold)] transition-colors">
                    (703) 629-9056
                  </a>
                </div>
                <div>
                  <div className="text-[10px] tracking-[0.3em] uppercase text-[color:var(--kb-muted)] mb-3">{t.labelLocations}</div>
                  <ul className="space-y-1.5" data-testid="contact-locations-list">
                    {LOCATIONS.map((loc) => (
                      <li key={loc.key} className="font-serif-kr text-base text-[color:var(--kb-text)]/85">
