...
const CONTENT = {
  ...
  en: {
    ...
    subtitle: "Entering the U.S. takes more than a market plan. It takes the right market, the right structure, the right partners, and the right decisions at each step. K Bridge brings those pieces together under one team, from the first market assessment through opening and beyond.",
    why: "Why it matters",
    pillars: [
      { en: "Market Research & Strategy", title: "Market Research & Strategy", icon: Compass,
        body: "We combine regional, category, and consumer intelligence to identify priorities and determine the right approach for entering the U.S. We narrow the options with data, then validate them in the field.",
        why: "The U.S. is not one market. Each city has its own customers, competition, costs, and opportunities. Choosing the right first market and entry strategy can shape your capital efficiency and growth for the next 3 to 5 years.",
        items: ["Market, competitor, and trade area analysis", "Category and regional entry priorities", "Direct, JV, and franchise evaluation", "Financial modeling and capital planning"] },
      { en: "Local Network Connections", title: "Local Network Connections", icon: Network,
        body: "Lawyers, accountants, contractors, suppliers, and other local professionals can make or break an expansion. We connect you with trusted partners who understand the U.S. market.",
        why: "Even the best strategy can stall without the right people to execute it. Finding reliable U.S. lawyers, accountants, contractors, and other partners can take months on your own. K Bridge gives you access to a pre-vetted network from day one.",
        items: ["Legal and accounting introductions", "Contractor and supplier matching", "Partner vetting and pre-screening", "Introductions based on your immediate needs"] },
      { en: "Entity Setup", title: "Entity Setup", icon: Landmark,
        body: "State, entity structure, tax considerations, and licensing all need to work together with your long-term plans. We help establish the right foundation for your business from the start.",
        why: "The structure you choose today can affect your tax exposure, fundraising options, ownership, and risk years from now. We help you build for flexibility rather than simply choosing what is easiest today.",
        items: ["Entity formation, EIN, and registration", "Coordination with accounting and legal partners", "Permits and licensing", "Vendor and opening readiness"] },
      { en: "Commercial Real Estate", title: "Commercial Real Estate", icon: Building2,
        body: "From site analysis to lease negotiation, we help you evaluate locations and navigate the details that can have a major impact on your business.",
        why: "A commercial lease is more than the rent. Terms such as NNN, CAM, TI, and exclusive use can significantly affect your costs and long-term profitability. Understanding the deal and negotiating the right terms can make a meaningful difference.",
        items: ["Site analysis and trade area study", "Lease review including NNN, CAM, TI, and exclusive use", "Landlord negotiation and terms optimization", "Final site selection"] },
      { en: "Franchise Development", title: "Franchise Development", icon: Store,
        body: "FDD preparation, state registration, master franchise models, and local partner introductions. We help bring the pieces together to build a franchise model designed for the U.S. market.",
        why: "U.S. franchising is governed by both federal and state regulations. Building the right structure from the beginning gives your brand a stronger foundation for growth while allowing you to scale with the right partners and capital.",
        items: ["U.S. franchise strategy", "FDD preparation and state registration", "Master franchise model evaluation", "Local partner sourcing"] },
      { en: "Store Opening & Operations", title: "Store Opening & Operations", icon: Rocket,
        body: "We stay involved through the final stages of your launch, including buildout, staffing, training, opening marketing, and post-opening operations.",
        why: "Opening the doors is only the beginning. The first 90 days provide valuable insight into what is working, what needs to change, and where the business should go next. We help you use that information to strengthen operations and reduce early-stage risk.",
        items: ["Buildout and vendor matching", "Staffing and training", "Opening marketing and PR", "Post-opening operations review"] },
    ],
  },
};
