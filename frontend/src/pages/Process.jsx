...
const CONTENT = {
  ...
  en: {
    eyebrow: "Our Process",
    title: "A Clear Path Into the U.S.",
    subtitle: "There is no single formula for entering the U.S. We shape the strategy around your brand and bring the right people, decisions, and resources together along the way.",
    ...
    steps: [
      ...
      { title: "Site Selection & Real Estate", timeline: "~ 8–16 weeks (market-dependent)",
        body: "We select target regions, analyze trade areas and foot traffic, and source available properties. From lease negotiation through contract execution, this is the most variable stage, with timelines shifting meaningfully based on market competition and landlord negotiation." },
