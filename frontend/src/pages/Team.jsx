  ...
  ko: {
    ...
    team: [
      ...
      },
      {
        ...
        bio: "20년 이상 부동산 개발과 다양한 산업에서 사업을 이끌어왔으며, 현재도 부동산 사업을 이어가고 있습니다. 괌에서 호텔 개발 프로젝트를 처음부터 직접 기획하고 추진했으며, 압구정 로데오거리에서 패션·라이프스타일 브랜드 사업을 운영했습니다. Fendi, BMW 등 글로벌 브랜드에서도 실무 경험을 쌓았으며, 호텔·리테일·이커머스에 이르기까지 여러 산업에서 직접 사업을 일으키고 이끌어온 경험을 갖추고 있습니다.",
    ...
    team: [
      {
        name: "Jessica Chong",
        title: "CEO",
        role: "Real Estate · Finance · Global Brand Leadership",
        stat: "25+ years · Real estate · Global brand operations",
        bio: "For over 25 years, Jessica has led businesses across finance, real estate, and global brands. She began her career at a financial institution, where she built a sharp instinct for numbers and risk — an instinct that has shaped every business decision since. Working in the field with global brands, she developed a firsthand understanding of what it takes for a brand to establish itself in a new market, and for 20 years she personally ran a real estate company spanning both commercial and residential properties. At K Bridge Partners, she brings all of that experience to leading the overall direction — helping Korean brands land in the U.S. market on solid footing.",
        tags: ["Executive Leadership", "Real Estate Leadership", "Global Brand Strategy", "Global Market Entry"],
      },
      {
        name: "Joy Chong",
