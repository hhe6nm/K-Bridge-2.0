  ...
  ko: {
    ...
    team: [
      ...
      },
      {
        ...
        bio: "Daniel Oh은 마이애미 대학교(University of Miami)를 졸업했으며, 이후 부동산 개발과 이커머스, 사모투자 기반의 투자자 관계 분야를 아우르며 커리어를 쌓아왔습니다. 미국 내 40개 이상의 IHOP 매장을 소유, 운영하는 중국계 투자자 그룹과 긴밀히 협력하며 자본 운용과 프랜차이즈 확장 전략을 자문하고 있습니다. 개발 부문에서는 매물 발굴부터 시공업체 조율, 협상, 실행까지 딜의 전 과정을 직접 관리합니다. 투자자 관계 구축과 현장 프로젝트 매니지먼트를 모두 아우르며, 자본이 실제 완공된 개발로 이어지는 전 과정을 이끌고 있습니다.",
  ...
  en: {
    ...
    team: [
      ...
      },
      {
        ...
        bio: "Daniel studied at the University of Miami before building a career across real estate development, e-commerce, and private equity-style investor relations. He works closely with an investor group from China that owns and operates more than 40 IHOP locations across the U.S., advising on capital deployment and franchise expansion strategy. On the development side, he manages every stage of a deal from sourcing the property to coordinating contractors, negotiating terms, and overseeing execution through completion. His background spans both sides of the table, structuring investor relationships and running the on-the-ground project management that turns capital into completed developments.",
        tags: ["Private Equity", "Real Estate Development", "Investor Relations", "Franchise Expansion"],
      },
    ],
  },
